				...
				<li id="yith-wcwl-row-<?php echo esc_attr($item->get_product_id()); ?>" data-row-id="<?php echo esc_attr($item->get_product_id()); ?>">
					...
					<div class="item-wrapper">
						...
						<div class="item-details">
							<div class="product-name">
								<h3>
									<a href="<?php echo esc_url(get_permalink(apply_filters('woocommerce_in_cart_product', $item->get_product_id()))); ?>" class="text-decoration-none fw-bold">
							...
							<?php if ($show_variation || $show_dateadded || $show_price) : ?>
								<table class="item-details-table fs-5">
					...
					<div class="additional-info-wrapper">
						...
						<?php if ($show_add_to_cart && isset($stock_status) && 'out-of-stock' !== $stock_status) : ?>
							<div class="product-add-to-cart">
								...
								woocommerce_template_loop_add_to_cart(array(
									...
									'class' => 'text-white text-decoration-none btn btn-success text-white fw-bold montserrat-font w-fit-content'
								));
								?>
							</div>
						<?php endif ?>
						...
						<?php if ($show_remove_product || $repeat_remove_button) : ?>
							<div class="product-remove text-center">
								<a href="<?php echo esc_url(add_query_arg('remove_from_wishlist', $item->get_product_id())); ?>" class="remove_from_wishlist text-white text-decoration-none btn btn-danger text-white fw-bold w-fit-content montserrat-font" title="<?php echo esc_html(apply_filters('yith_wcwl_remove_product_wishlist_message_title', __('Remove this product', 'yith-woocommerce-wishlist'))); ?>">
									<?php _e('Remove', 'gps-pharmacy-solutions'); ?>
								</a>
							</div>
						<?php endif; ?>
					</div>
