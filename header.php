...
<head>
	...
	<link rel="icon" type="image/svg+xml" href="<?php echo get_theme_file_uri() . "/icons/favicon.svg" ?>" />
	<link rel="shortcut icon" href="<?php echo get_theme_file_uri() . "/icons/favicon.ico" ?>" />
	<link rel="apple-touch-icon" sizes="180x180" href="<?php echo get_theme_file_uri() . "/icons/apple-touch-icon.png" ?>" />
	<link rel="manifest" href="<?php echo get_theme_file_uri() . "/icons/site.webmanifest" ?>" />
