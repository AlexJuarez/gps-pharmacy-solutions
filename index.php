...
<main id="primary" class="site-main">
    ...
    <div class="container mb-7 mt-6 mt-lg-0 w-100">
      <div class="g-0 row">
        <div class="col-lg-6 ms-lg-auto px-4">
          ...
          <h1 class="mb-4 montserrat-font text-darkblue">GPS Pharmacy in Charlotte NC - The Premiere Concierge Pharmacy
            of the Carolinas.</h1>
          <a class="btn btn-blue btn-sm fw-bold montserrat-font px-4 rounded small py-2"
            href="<?= get_permalink(wc_get_page_id('shop')) ?>">Explore Now</a>
        </div>
      </div>
    </div>
            ...
            <div class="info-card-container">
              <div class="gps-info-box gps-compounding">
                <div class="gps-info-box-back gps-info-box-fbc d-flex flex-column justify-content-center gps-bg-blue">
                  <a class="" data-hero-trigger="womens-health"
                    href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Women\'s Health']); ?>">Women's
                    Health</a>
                  <a data-hero-trigger="mens-health"
                    href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Men\'s Health']); ?>">Men's
                    Health</a>
                  <a data-hero-trigger="sterile-compounding"
                    href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Sterile Compounding']); ?>">Sterile
                    Compounding (coming soon)</a>
                  <a data-hero-trigger="veterinary-2"
                    href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Veterinary']); ?>">Veterinary</a>
                  <a class="" data-hero-trigger="aesthetics"
                ...
                <div
                  ...
                  <div class="align-items-center d-flex flex-column justify-content-center ">
                    <div class="icon">
                      <img src="<?php echo get_theme_file_uri() . '/img/homepage/compounding.svg'; ?>"
                        alt="Compounding">
                    </div>
                  ...
                  <div class="button montserrat-font">
                    <a href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Compounding']); ?>">Explore
                      Now</a>
                  </div>
                </div>
              </div>
            ...
            <div class="info-card-container">
              <div class="gps-info-box gps-hospice">
                <div class="gps-info-box-back gps-info-box-fbc d-flex flex-column justify-content-center bg-warning">
                  <a class="" data-hero-trigger="medication-access"
                    href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Medication Access']); ?>">Medication
                    Access</a>
                  <a data-hero-trigger="clinical-support"
                    href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Clinical Support']); ?>">Clinical
                    Support</a>
                  <a data-hero-trigger="best-pricing"
                    href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Best in Industry Pricing']); ?>">Best
                    in Industry Pricing</a>
                  <a data-hero-trigger="infusion-therapy"
                    href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Infusion Therapy']); ?>">Infusion
                    Therapy</a>
                  <a data-hero-trigger="compounding"
                    href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Hospice Compounding & Wound Management']); ?>">Hospice
                    Compounding & Wound Management</a>
                  <a class="" data-hero-trigger="pbm"
                    href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['PBM Solutions with PDCRx']); ?>">PBM
                    Solutions</a>
                  <div class="button montserrat-font">
            ...
            <div class="info-card-container">
              <div class="gps-info-box gps-research">
                <div class="gps-info-box-back gps-info-box-fbc d-flex flex-column justify-content-center bg-info">
                  <a class=""
                    href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Clinical Trials and Research']); ?>">Clinical
                ...
                <div
                  ...
                  <div class="button montserrat-font">
                    <a
                      href="<?php echo get_permalink(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Clinical Trials and Research']); ?>">Explore
                      Now</a>
                  </div>
                </div>
              </div>
            ...
            <div class="info-card-container">
              <div class="gps-info-box gps-shop">
                <div class="gps-info-box-back gps-info-box-fbc d-flex flex-column justify-content-center bg-success">
                  <a data-hero-trigger="shop"
                    href="<?php echo get_category_link(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Anti-aging for Women and Men']); ?>">Anti-aging
                    for Women and Men</a>
                  <a data-hero-trigger="shop"
                    href="<?php echo get_category_link(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Lashes']); ?>">Lashes</a>
                  <a class="" data-hero-trigger="shop"
                    href="<?php echo get_category_link(GPS_PHARMACY_SOLUTIONS_PAGE_IDS['Hair Restoration for Women and Men']); ?>">Hair
    ...
    <div class="container py-3 py-lg-4">
      <div class="row">
        ...
        <div class="col-lg-6 text-center text-lg-start">
          <p>As a proud member of PCCA, GPS Pharmacy Solutions offers the highest quality ingredients and medications
            for the health of yourself, your family, and your pets! All of our compounding drugs are custom-made,
            precisely to your specific prescription. This means if you need a medication that isn't readily available on
            generic pharmacy shelves, we can create it for you!</p>
          <p>Isn't it time you simplified the healthy lives of your pets, family members, and yourself? Our popular
            same-day medication delivery brings all of your prescription compounded drugs to your door, whether you live
            in Charlotte NC, Mint Hill, or another community in the surrounding areas.</p>
          <p>Gone are the days of making appointments or searching for reliable or local pharmacy locations near you.
            Once you place your order online or over the phone, our staff will immediately begin to refill or prepare
            your medications. Expect to receive them at your door within the same day!</p>
          <p class="mb-5">Wondering if we deliver to your current location? Reach out and we will be in touch shortly.
          </p>
          <a class="btn btn-blue btn-sm fw-bold montserrat-font px-4 rounded small py-2"
            href="<?= get_permalink(get_page_by_path('compounding')) ?>">Explore Now</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container py-3 py-lg-4">
      <div class="row">
        <div class="align-items-center col-lg-6 d-flex justify-content-center mb-5 mb-lg-0 pe-lg-5">
          <h2 class="montserrat-font mb-0 text-primary">GPS Pharmacy in Charlotte NC Delivers Your Specialty Compounded
            Prescriptions Right to Your Door</h2>
        </div>
        <div class="col-lg-6 text-center text-lg-start">
          <p>Are you in need of custom compounding or palliative prescriptions? Need them quickly? GPS Pharmacy
            Solutions is the 24-hour pharmacy that specializes in same-day delivery of medications and prescriptions for
            the health of your loved ones and pets. We're currently serving Charlotte, Mint Hill, the surrounding North
            Carolina areas, and South Carolina, Illinois, Ohio, and Georgia.</p>
  ...
  <section class="bg-blue container-fluid py-5 text-white">
    <div class="row">
      <div class="col-lg-6 mx-auto py-3 py-lg-4 text-center">
        ...
        <p class="mb-5">Whichever compounding needs you, your family, or pets may have, our pharmacy system has a
          concierge solution custom fit to you. We specialize in:</p>
        <div class="mb-5 row">
          <div class="col-xl-10 mx-auto">
            <ul class="bullet-warning g-0 mx-n4 row text-start">
              <li class="col-md-6 px-4">
                <div class="border-bottom border-darkblue py-2 text-truncate">BHRT <small
                    class="fw-normal">(Bio-identical Hormone Replacement Therapy)</small></div>
              </li>
              <li class="col-md-6 px-4">
  ...
  <section class="bg-white py-5 text-center">
    <div class="container py-3 py-lg-4">
      <p class="mb-0"><strong>GPS Pharmacy Charlotte NC</strong>, is a concierge compounding pharmacy with same-day
        medication delivery to patients located in North Carolina and South Carolina. We also offer free ground shipping
        to other states. GPS Pharmacy specializes in BHRT compounding, veterinary compounding, pediatric compounding,
        hospice compounding, wound care, and much more. Our state-of the-art USP <795>, USP <797>, and USP <800>
              compounding facilities are located in Charlotte, NC. GPS Pharmacy services hospital systems with 24-hour
              medication delivery.</p>
    </div>
  </section>
